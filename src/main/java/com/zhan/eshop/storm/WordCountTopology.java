 ...
 * storm的课程，我就只是讲到，最基本的开发，就够了，java开发广告计费系统，大量的流量的引入和接入，就是用storm做的
...
public class WordCountTopology {
    ...
    public static class RandomSentenceSpout extends BaseRichSpout {
        ...
        private static final long serialVersionUID = 1285017489681577480L;
         ...
         * 这样的话呢，无限循环调用，可以不断发射最新的数据出去，形成一个数据流
         */
